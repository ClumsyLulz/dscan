...
# ------------------------------
# Paths to check (full list)
# ------------------------------
paths_to_check=( 
"core/install.php" "core/authorize.php" "core/rebuild.php"
"core/modules/statistics/statistics.php" "core/modules/system/tests/https.php"
"core/modules/system/tests/http.php" "autoload.php" "composer.json" "composer.lock"
".git" ".svn" ".DS_Store" ".well-known" "CHANGELOG.txt" "INSTALL.txt"
"LICENSE.txt" "MAINTAINERS.txt" "README.txt" "UPGRADE.txt" "phpinfo.php"
".htaccess" "robots.txt" "web.config" ".env" ".htpasswd" "includes"
"misc" "modules" "profiles" "scripts" "sites" "themes"
"/admin" "/admin/config" "/admin/config/system" "/admin/config/people"
"/admin/config/media" "/admin/appearance" "/admin/modules" "/admin/content"
"/admin/reports" "/admin/structure" "/admin/structure/block" "/admin/structure/taxonomy"
"/admin/structure/views" "/admin/structure/menu" "/admin/structure/paragraphs"
"/admin/structure/layout" "/admin/structure/search" "/admin/structure/entity"
"/admin/structure/migrate" "/admin/structure/fields" "/admin/structure/users"
"/admin/structure/custom-blocks" "/admin/config/services" "/admin/config/media/image-style"
"/admin/config/system/performance" "/admin/config/system/smtp"
"/admin/config/search/search-api" "/admin/config/search/search-api/index"
"/admin/config/search/search-api/server" "/admin/config/development/logging"
"/admin/config/development/cache" "/admin/config/development/performance"
"/admin/config/development/debugging" "/admin/config/development/redis"
"/admin/config/development/override" "/admin/config/development/agentrace"
"/admin/config/people/accounts" "/admin/config/people/password-policy"
"/admin/config/people/roles" "/admin/config/people/permissions"
"/admin/config/people/registration" "/admin/config/people/session"
"/admin/config/people/login" "/admin/config/people/accounts/form"
"/admin/config/people/roles/permissions" "/admin/config/people/roles/create"
"/admin/config/people/roles/update" "/admin/config/people/roles/delete"
...
"/core" "/core/install.php" "/core/misc" "/core/scripts" "/core/vendor"
"/core/lib" "/core/themes" "/core/assets" "/sites/default/files/"
"/sites/default/private/" "/sites/default/settings.php" "/sites/default/cron.php"
...
"/entity/{entity_type}/{id}/delete" "/entity/{entity_type}/{id}/view"
"/entity/{entity_type}/{id}/field" "/entity/{entity_type}/{id}/permissions"
"/entity/{entity_type}/{id}/assign" "/entity/{entity_type}/{id}/parent"
"/entity/{entity_type}/{id}/content" "/entity/{entity_type}/{id}/custom-fields"
"/entity/{entity_type}/create" "/entity/{entity_type}/update" "/entity/{entity_type}/delete"
"/entity/{entity_type}/views" "/entity/{entity_type}/manage" "/entity/{entity_type}/settings"
...
"/entity/{entity_type}/create-form" "/entity/{entity_type}/edit-form"
"/entity/{entity_type}/translations-form" "/entity/{entity_type}/delete-form"
...
"/entity/{entity_type}/field/{field_name}/view-form" "/entity/{entity_type}/field/{field_name}/field-definition"
"/entity/{entity_type}/field/{field_name}/create-form" "/entity/{entity_type}/field/{field_name}/remove-form"
"/entity/{entity_type}/field/{field_name}/field-definition-form" "/entity/{entity_type}/field/{field_name}/permissions-form"
"/robots.txt" "/crossdomain.xml" "/xmlrpc.php" "/update.php" "/about" "/help"
"/donate" "/terms-of-service" "/privacy-policy" "/404"
)
...
printf "%s\n" "${paths_to_check[@]}" | xargs -n1 -P "$MAX_THREADS" -I{} bash -c 'check_path "'"$TARGET_URL"'" "{}"'
